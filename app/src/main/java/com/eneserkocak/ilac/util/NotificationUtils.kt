...
import com.eneserkocak.ilac.view.MainActivity


class  NotificationUtils(base: Context, val mIntent: Intent) : ContextWrapper(base) {
    ...
    fun getNotificationBuilder(): NotificationCompat.Builder {
        ...
        val ilacAdi = mIntent.getStringExtra(ILAC_ADI)
        val pendingIntent = PendingIntent.getActivity(this, 0, intent, 0)
        return NotificationCompat.Builder(applicationContext, MYCHANNEL_ID)
            .setContentTitle("İLAÇ ZAMANI")
            .setContentText(ilacAdi)
